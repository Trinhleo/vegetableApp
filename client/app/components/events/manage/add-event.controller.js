(function () {
    ...
    AddEventController.$inject = ['$state', '$localStorage', '$rootScope', '$scope', 'EventService', 'geolocation', 'FileUploader', 'appConfigs', '$window', '$timeout', 'toastr'];

    function AddEventController($state, $localStorage, $rootScope, $scope, EventService, geolocation, FileUploader, appConfigs, $window, $timeout, toastr) {
        var vm = this;
        ...
        function onSuccessItem(fileItem, response, status, headers) {
            ...
            EventService.updateEvent(data).then(function (res) {
                // vm.success = "success";
                vm.event = res;
                toastr.success("Success on create new event!", "Create Event");
                $rootScope.$broadcast('new event', vm.event);
                getEventsLocation();
